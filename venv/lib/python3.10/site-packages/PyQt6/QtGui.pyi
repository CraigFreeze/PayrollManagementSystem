...
class QColor(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def isValidColorName(a0: typing.Union[QtCore.QByteArray, str]) -> bool: ...
    @staticmethod
    def fromString(name: typing.Union[QtCore.QByteArray, str]) -> 'QColor': ...
...
class QPainter(PyQt6.sip.simplewrapper):
    ...
    def strokePath(self, path: 'QPainterPath', pen: typing.Union['QPen', QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    ...
    @typing.overload
    def setPen(self, pen: typing.Union['QPen', QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    @typing.overload
...
class QPainterPathStroker(PyQt6.sip.simplewrapper):
    ...
    def __init__(self) -> None: ...
    @typing.overload
    def __init__(self, pen: typing.Union['QPen', QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
...
class QTextCharFormat(QTextFormat):
    ...
    def setTextOutline(self, pen: typing.Union[QPen, QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
